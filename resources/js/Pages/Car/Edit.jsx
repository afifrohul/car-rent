...
export default function Edit({ car, brands, types, cities }) {
    const { errors } = usePage().props;
    const [form, setForm] = useState({
        name: car.name || "",
        brand_id: String(car.brand_id) || "",
        type_id: String(car.type_id) || "",
        city_id: String(car.city_id) || "",
        desc: car.desc || "",
        total_seat: car.total_seat || "",
    ...
    return (
        <AdminLayout siteHeader={<SiteHeader name="Edit Car" />}>
            <Head title="Edit Car" />
